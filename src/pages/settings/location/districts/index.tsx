...
export function DistrictsListPage() {
  ...
  const [columnOrder, setColumnOrder] = useState<string[]>(["id", "name", "description", "isActive", "actions"]);
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center gap-3 justify-between">
        ...
        />
        <CreateButton
          label={t("districts.actions.create", "Etrap döret")}
          onClick={() => navigate("/settings/location/districts/create")}
        />
      </div>
      ...
      <DeleteDialog
        ...
        description={t("districts.deleteConfirm", "Bu etrapy öçürmek isleýärsiňizmi?")}
        onConfirm={() => {
          if (deleteId !== null) {
