    ...
    },
    {
      ...
      cell: ({ row }) => (
        <TableActions
          ...
          onView={() => navigate(`/card-transactions/${row.original.id}`)}
          onEdit={() => navigate(`/card-transactions/${row.original.id}/edit`)}
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-semibold text-foreground">{t("Card transactions", "Kart hereketleri")}</h1>
      </div>
      ...
      <div className="flex items-center gap-3 justify-between">
        ...
        />
        <CreateButton label={t("Create card transaction", "Kart herekedi dörediň")} onClick={() => navigate("/card-transactions/create")} />
      </div>
