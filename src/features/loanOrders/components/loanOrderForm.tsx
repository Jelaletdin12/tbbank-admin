  ...
  return (
    <div className="space-y-4">
      ...
      <BentoGrid cols={2}>
        ...
        <BentoCard>
          <FormInput type="searchable-select" label={t('Expiration month') || 'Möhleti (aý)'} required value={form.guarantor1CardExpMonth} onChange={(v) => set('guarantor1CardExpMonth', v)} options={MONTH_OPTIONS} placeholder={t('loanOrderForm.placeholders.searchableSelect') || 'Saýlamak üçin basyň'} error={errors.guarantor1CardExpMonth} />
          <FormInput type="searchable-select" label={t('Expiration year') || 'Möhleti (ýyl)'} required value={form.guarantor1CardExpYear} onChange={(v) => set('guarantor1CardExpYear', v)} options={YEAR_OPTIONS} placeholder={t('loanOrderForm.placeholders.searchableSelect') || 'Saýlamak üçin basyň'} error={errors.guarantor1CardExpYear} />
    ...
    <div className="flex flex-col gap-5">
      ...
      <div>
        <h1 className="text-xl font-semibold text-foreground">
          {mode === 'create'
            ? (t('loanOrders.create') || 'Karz sargyt döredüň')
            : (t('loanOrders.edit')   || 'Karz sargydy üýtget')}
        </h1>
      ...
      <FormActions
        ...
        submitLabel={
          mode === 'create'
            ? (t('loanOrders.createButton') || 'Karz sargyt döredüň')
