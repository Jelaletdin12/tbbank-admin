...
const statuses: Array<"GARASYLYYAR" | "KANAGATLANDYRYLAN" | "RET_EDILEN"> = ["GARASYLYYAR", "KANAGATLANDYRYLAN", "RET_EDILEN"];

const documentLabels = [
  { id: "rekvezit", name: "Rekvezit.jpg", label: 'Talyba degisli walýuta "SBERBANK" kartyň rekwizitleri' },
  {
    id: "sprawka",
    name: "sprawka-2026.jpg",
    label: "Talybýň daşary ýurt döwletiniň ýokary okuw mekdebinde okaýandygy baradaky güwanamasy",
  },
  { id: "bildirish", name: "bildirish.jpg", label: "Talybýň bildirisli göcürmesi" },
  {
    id: "passport-copy",
    name: "Tkm-pas-Agayewa-Mahllan-(1).jpg",
    label: "Talyba degisli Türkmenistanyň raýatynyň içki milli pasportynyň asyl görnüşi we göçürmesi",
  },
  {
    id: "zagran-1",
    name: "Zagran-(1).jpg",
    label: "Talybýň Türkmenistandan çykmak we Türkmenistana girmek üçin (zagran) pasportynyň göçürmesi",
  },
  {
    id: "zagran-2",
    name: "Zagran-(2).jpg",
    label:
      "Talybýň Türkmenistandan çykmak we Türkmenistana girmek üçin pasportyndaky daşary ýurda çykmak üçin tälynjädägy baradaky beriim miiletti hereket edijan rughsatnamasyniyň (wizasynyň) bellenen sahypasynyň göçürmesi",
  },
];
...
const mockPaymentOrders: SberPaymentOrder[] = Array.from({ length: 100 }, (_, i) => generateMockPaymentOrder(i));
...
export async function createSberPaymentOrder(payload: CreateSberPaymentPayload): Promise<SberPaymentOrder> {
...
export async function updateSberPaymentOrder(payload: UpdateSberPaymentPayload): Promise<SberPaymentOrder> {
  await new Promise((resolve) => setTimeout(resolve, 400));
