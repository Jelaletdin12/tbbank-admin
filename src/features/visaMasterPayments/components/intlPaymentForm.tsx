...
const STEPS: StepDef[] = [
  {
    id: "general",
    titleKey: "intlPaymentForm.steps.general.title",
    titleFallback: "Esasy",
    subtitleKey: "intlPaymentForm.steps.general.subtitle",
    subtitleFallback: "Status, müşderi",
    icon: User,
    validate: (f, m) => validateStep(0, f, m),
  },
  {
    id: "location",
    titleKey: "intlPaymentForm.steps.location.title",
    titleFallback: "Lokasiýa",
    subtitleKey: "intlPaymentForm.steps.location.subtitle",
    subtitleFallback: "Welaýat, şahamça",
    icon: MapPin,
    validate: (f, m) => validateStep(1, f, m),
  },
  {
    id: "personal",
    titleKey: "intlPaymentForm.steps.personal.title",
    titleFallback: "Şahsy",
    subtitleKey: "intlPaymentForm.steps.personal.subtitle",
    subtitleFallback: "Pasport, kontakt",
    icon: IdCard,
    validate: (f, m) => validateStep(2, f, m),
  },
  {
    id: "payment",
    titleKey: "intlPaymentForm.steps.payment.title",
    titleFallback: "Töleg",
    subtitleKey: "intlPaymentForm.steps.payment.subtitle",
    subtitleFallback: "Töleýji, kabul ediji",
    icon: CreditCard,
    validate: (f, m) => validateStep(3, f, m),
  },
  {
    id: "docs",
    titleKey: "intlPaymentForm.steps.docs.title",
    titleFallback: "Resminamalar",
    subtitleKey: "intlPaymentForm.steps.docs.subtitle",
    subtitleFallback: "15 resminama",
    icon: Files,
    validate: () => ({}),
  },
];
...
function StepDocs({ form, set }: StepContentProps) {
  return (
    <BentoGrid cols={2}>
      <BentoCard>
...
export function IntlPaymentForm({ mode, initialData }: IntlPaymentFormProps) {
  ...
  const set = useCallback(
    <K extends keyof IntlPaymentFormData>(key: K, value: IntlPaymentFormData[K]) => {
  ...
  return (
    <div className="mx-auto space-y-6">
      ...
      <FormActions
        ...
        submitLabel={mode === "create" ? t("intlPayment.createBtn", "Dörediň") : t("intlPayment.editBtn", "Redaktirläň")}
      />
    </div>
  );
}
