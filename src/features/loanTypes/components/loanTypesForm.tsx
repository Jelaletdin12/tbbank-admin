  ...
  return (
    <div className="flex flex-col gap-5">
      <h1 className="text-xl font-semibold text-foreground">
        {mode === "create" ? t("loanTypes.createTitle", "Karz görnüşi dörediň") : t("loanTypes.editTitle", "Karz görnüşi üýtgetmek")}
      </h1>
      <BentoGrid cols={2}>
        <BentoCard span="full">
        ...
        <BentoCard span="full">
          <p className="text-sm font-semibold text-muted-foreground mb-1">{t("loanTypes.fields.notes", "Bellikler")}</p>
          <MultiLangInput fields={notesFields} placeholder={t("loanTypes.fields.notes", "Bellikler")} disabled={isPending} />
        </BentoCard>
        <BentoCard>
          <div className="flex items-center gap-2 pt-1">
            <span className="text-sm font-semibold text-muted-foreground">{t("loanTypes.fields.isActive", "Işjeň")}</span>
            <Checkbox id="isActive" checked={form.isActive} onCheckedChange={(checked) => set("isActive")(!!checked)} />
      ...
      <FormActions
        ...
        cancelVariant="ghost"
        submitLabel={mode === "create" ? t("loanTypes.actions.create", "Karz görnüşi dörediň") : t("loanTypes.actions.save", "Ýatda sakla")}
      />
    </div>
  );
}
