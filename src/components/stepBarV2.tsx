...
/**
 * Card-style horizontal step bar (icon + title + subtitle, chevron separators).
 * Inspired by the reference mockup. Uses semantic tokens only.
 */
              ...
              <span className="flex flex-col items-start text-left leading-tight">
                <span
                  className={cn(
                    ...
                    isActive || isDone ? 'text-foreground' : 'text-foreground/90',
